...
> 🤖 **AI 기반 자동 수행** — 이 공격 체인은 전 단계를 **AI(Claude)** 가 **Kali MCP**를 통해 자동 오케스트레이션했으며, 탐지 결과는 **Cortex MCP**로 조회·분석했습니다. ([AI 퍼플팀 구조 →](../README.md))
...
> 🤖 **AI 수행** — Claude가 **Kali MCP**를 통해 이 단계를 자동 오케스트레이션합니다.
...
> 🔵 **AI 분석** — Claude가 **Cortex MCP**로 아래 탐지 결과를 조회·분석해 SOC 리포트로 요약합니다.
