"""
XSIAM XQL Public API 자동화 - ADB 사용 로그
출력: adb_log.json
"""
...
| filter action_process_image_name = "adb.exe"
| alter _time = format_timestamp("%Y-%m-%d %H:%M:%S", _time, "Asia/Seoul")
| fields _time, agent_hostname, actor_effective_username,
         causality_actor_process_image_path, causality_actor_process_image_name,
         causality_actor_process_command_line, causality_actor_process_image_sha256,
         action_process_image_path, action_process_image_name,
