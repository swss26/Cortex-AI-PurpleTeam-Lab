"""
XSIAM XQL Public API 자동화 - 프로세스 차단 로그
출력: process_block_log.json
"""
...
OUTPUT_FILE       = "process_block_log.json"
POLL_INTERVAL_SEC = 3
...
XQL_QUERY = """
dataset = alerts
| filter alert_name = "Execution From a Restricted Folder"
| alter _time = format_timestamp("%Y-%m-%d %H:%M:%S", _time, "Asia/Seoul")
| fields _time, alert_id, host_name, host_ip, alert_name, category,
         initiator_path, initiated_by, initiator_sha256
| sort desc _time
"""
