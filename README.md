...
| 항목 | 내용 |
|------|------|
| Ubuntu | 14.04 LTS · `song-test-old-ubuntu` · `172.16.157.190` · Cortex XDR 에이전트 설치됨 |
| Windows | 11 · `SONG-TEST-OC` · `172.16.157.187` · Cortex XDR 에이전트 설치됨 |
| 공격 머신 (Kali) | `172.16.157.177` |
| Windows C2 서버 | `172.16.140.6` (DNS :53 · HTTP :8080) |
